	...
	return (
		<div className="container mx-auto py-6 space-y-6">
			...
			<Tabs defaultValue="all" className="w-full">
				<TabsList className="mb-4 py-1 gap-1 flex flex-wrap h-auto rounded-lg">
					<TabsTrigger
						value="all"
						onClick={() => setActiveModule(null)}
						className="data-[state=active]:bg-primary data-[state=active]:text-zinc-50 rounded-lg py-2"
					>
						Todos los videos
					</TabsTrigger>
					{modules.map((module) => (
